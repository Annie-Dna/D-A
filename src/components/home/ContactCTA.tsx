          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="max-w-lg">
              ...
              <p className="text-gray-600 mb-8">
                Ready to be part of something bigger? Join Dream N Achieve and connect with like-minded young individuals who are passionate about personal growth, leadership, and making a positive impact in the community.
              </p>
